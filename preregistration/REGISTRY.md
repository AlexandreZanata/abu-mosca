...
Pacote da minuta 1.0 preparado em 2026-09-14 (R07). Os hashes abaixo congelam o
conteúdo dos artefatos; a assinatura humana é obrigatória para tornar o
pré-registro válido. Qualquer edição posterior invalida os hashes e exige
entrada no `CHANGELOG.md` e nova assinatura quando afetar o confirmatório.
...
- SHA-256 `8b678293741bd364090a8064da4077a17685db34ab3a41246d1c68c32d3b90e5` — `preregistration/CHANGELOG.md`
...
- Data da assinatura: a preencher
- Hash do pacote assinado: a preencher (SHA-256 do `REGISTRY.md` no commit de assinatura)

## 3. Regras

- O pré-registro só vale após as três assinaturas e o registro da data.
